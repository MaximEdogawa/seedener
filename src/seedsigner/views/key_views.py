...
from seedsigner.models.key import InvalidKeyException, Key
from seedsigner.gui.screens import (RET_CODE__BACK_BUTTON, ButtonListScreen, WarningScreen, DireWarningScreen ,key_screens)
...
class KeyTranscribeKeyQRConfirmScanView(View):
    ...
    def run(self):
        ...
        from seedsigner.models import DecodeQR
