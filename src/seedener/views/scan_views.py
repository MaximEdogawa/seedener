...
from seedener.gui.screens.screen import RET_CODE__BACK_BUTTON
from seedener.models import DecodeQR, Seed
            ...
            if self.decoder.is_seed:
                ...
                if not seed_mnemonic:
                    ...
                    if self.settings.get_value(SettingsConstants.SETTING__PASSPHRASE) == SettingsConstants.OPTION__REQUIRED:
                        from seedener.views.seed_views import SeedAddPassphraseView
                        return Destination(SeedAddPassphraseView)
                    else:
                        return Destination(SeedFinalizeView)
            
            elif self.decoder.is_psbt:
                from seedener.views.psbt_views import PSBTSelectSeedView
                ...
                from seedener.views.seed_views import MultisigWalletDescriptorView
                ...
                from seedener.views.seed_views import AddressVerificationStartView
...
class SettingsUpdatedView(View):
    ...
    def run(self):
        from seedener.gui.screens.scan_screens import SettingsUpdatedScreen
