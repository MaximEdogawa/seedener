...
from seedener.gui.screens.screen import LoadingScreenThread, QRDisplayScreen
...
from seedener.gui.screens.tools_screens import ToolsCalcFinalWordDoneScreen, ToolsCalcFinalWordFinalizePromptScreen, ToolsCalcFinalWordScreen, ToolsCoinFlipEntryScreen, ToolsDiceEntropyEntryScreen, ToolsImageEntropyFinalImageScreen, ToolsImageEntropyLivePreviewScreen, ToolsAddressExplorerAddressTypeScreen
from seedener.helpers import embit_utils, mnemonic_generation
from seedener.models.encode_qr import EncodeQR
from seedener.models.qr_type import QRType
from seedener.models.seed import Seed
from seedener.models.settings_definition import SettingsConstants
from seedener.views.seed_views import SeedDiscardView, SeedFinalizeView, SeedMnemonicEntryView, SeedWordsWarningView, SeedExportXpubScriptTypeView
...
class ToolsCalcFinalWordShowFinalWordView(View):
    ...
    def run(self):
        ...
        from seedener.helpers import mnemonic_generation
    ...
    def run(self):
        ...
        for seed in seeds:
            ...
            if seed.passphrase is not None:
                ...
                pass
            button_data.append((button_str, SeedenerCustomIconConstants.FINGERPRINT, "blue"))
        ...
        if len(seeds) > 0 and selected_menu_num < len(seeds):
            ...
            from seedener.views.seed_views import SeedMnemonicEntryView
...
class ToolsAddressExplorerAddressListView(View):
    ...
    def run(self):
        ...
        try:
            ...
            button_data.append(("Next {}".format(addrs_per_screen), None, None, None, SeedenerCustomIconConstants.SMALL_CHEVRON_RIGHT))
