...
from seedener.gui.components import FontAwesomeIconConstants, Fonts, FormattedAddress, GUIConstants, IconTextLine, SeedenerCustomIconConstants, TextArea

from seedener.gui.screens.screen import RET_CODE__BACK_BUTTON, BaseScreen, BaseTopNavScreen, ButtonListScreen, KeyboardScreen
from seedener.hardware.buttons import HardwareButtonsConstants
from seedener.helpers.qr import QR
from seedener.models.settings_definition import SettingsConstants, SettingsDefinition
    ...
    def __post_init__(self):
        ...
        if self.fingerprint:
            ...
            if self.script_type != SettingsConstants.CUSTOM_DERIVATION:
                self.components.append(IconTextLine(
                    icon_name=SeedenerCustomIconConstants.PATH,
