...
from seedener.hardware.buttons import HardwareButtonsConstants, HardwareButtons
...
class LargeIconStatusScreen(ButtonListScreen):
    title: str = "Success!"
    status_icon_name: str = SeedenerCustomIconConstants.CIRCLE_CHECK
...
class WarningScreen(WarningEdgesMixin, LargeIconStatusScreen):
    title: str = "Caution"
    status_icon_name: str = SeedenerCustomIconConstants.CIRCLE_EXCLAMATION
