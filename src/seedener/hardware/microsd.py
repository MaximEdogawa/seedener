...
#from seedener.views.view import MicroSDToastView
from seedener.gui.screens.screen import MicroSDToastScreen
...
class MicroSD(Singleton, BaseThread):
	...
	def run(self):
		...
		# explicitly only microsd add/remove detection in seedener-os
