...
from seedener.gui.components import Fonts, GUIConstants, load_image
from seedener.gui.screens.screen import BaseScreen
...
class OpeningSplashScreen(LogoScreen):
    def start(self):
        ...
        # Display version num below seedener logo
